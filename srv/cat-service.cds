...
type SalesWorkflowInputType : {
    ...
    shipToState: String;
    shipToStreet: String;
    to_Item: array of SalesWorkflowItemType;
};
...
service SalesCatalogService {
    ...
    action postSalesWorkflow(input: SalesWorkflowInputType) returns {
        message: String;
        response : String;
    };
